...
\section{Multiplication Factor (mul)}
...
Cell sizes were simulated for a stoichiometric mixture of \ce{CH4}-\ce{N2O} at 300 K and 1 atm using the \texttt{gri30\_highT.yaml} mechanism using Cantera and SDToolbox.
% todo: citations
