...
\begin{figure}[H]
    ...
    \caption{Non-normalized naive sensitivity coefficients (eq. \ref{eq:sc_mul}).}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Normalized naive sensitivity coefficients (eq. \ref{eq:nsc_base},~\ref{eq:sc_mul}).}
\end{figure}
