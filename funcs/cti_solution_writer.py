"""
Original script written by Parker Clayton
https://groups.google.com/d/msg/cantera-users/67860KYm6JY/gwsOb9_DAwAJ

Some modifications made for use in my research
"""
...
def write(solution, output_file_name='RESEARCH_INERT.cti'):
    ...
    if '.cti' not in output_file_name:
        output_file_name += '.cti'
    input_file_name_stripped = output_file_name.replace('.cti', '')
    ...
    with open(output_file, 'w+') as f:
        ...
        def build_modified_arrhenius(equation_object, t_range):
            """
            Builds Arrhenius coefficient strings for high and low temperature
            ranges
            ...
            if t_range == 'high':
                pre_exponential_factor = \
                    equation_object.high_rate.pre_exponential_factor
                temperature_exponent = \
            ...
            if t_range == 'low':
                pre_exponential_factor = \
                    equation_object.low_rate.pre_exponential_factor
                temperature_exponent = \
                    equation_object.low_rate.temperature_exponent
                activation_energy = (
                            equation_object.low_rate.activation_energy /
                            calories_constant)
        ...
        for sp_index, name in enumerate(trimmed_solution.species_names):
            ...
            if bool(species.transport) is True:
                ...
                dipole = str(
                    species.transport.dipole / debeye_conversion_constant)
        ...
        for eq_index in range(len(trimmed_solution.reaction_equations())):
            ...
            if equation_type == 'FalloffReaction':
                ...
                try:
                    ...
                    f.write('\n           )\n\n')
    return output_file, os.path.split(output_file)[0]
